...
In order to run this you will need nodejs installed as well as a local mongodb instance running. Running the 'node index.js' command will launch the server which can be accessed at yourIP:3214.
